package com.farben.platform.utils;

import com.farben.platform.api.base.FarbenError;
import com.farben.platform.api.dto.queryParam.MetadataQueryDTO;
import com.farben.platform.context.FarbenContext;
...
public class SqlSessionUtil {
    ...
    SqlSessionFactory getSqlSessionFactroy() {
        ...
        return FarbenContext.getSqlSessionFactory();
    }
    ...
    public SqlSession getSession(boolean isAutoCommit) {
        try {
            ...
            ex.printStackTrace();
            throw new FarbenError(-1, "getSession error:" + ex.getMessage());
